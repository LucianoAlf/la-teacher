...
const ERRO_TEXTO: Record<ErroChamada | 'desconhecido', string> = {
  ...
  janela_de_chamada_encerrada: `O prazo de ${JANELA_POS_AULA_DIAS} dias pra lançar esta chamada já fechou. Passado o prazo, só a coordenação libera — fala com ela.`,
    ...
    <div className="flex flex-1 flex-col">
      ...
      {!enviada && !semRoster && naoConciliados.length === 0 && janela === 'encerrada' && (
        <Aviso icone="fa-solid fa-lock" tom="warn">
          O prazo de {JANELA_POS_AULA_DIAS} dias pra lançar esta chamada fechou. Passado o prazo, só a
          coordenação libera — fala com ela que dá pra reabrir.
        </Aviso>
      )}
